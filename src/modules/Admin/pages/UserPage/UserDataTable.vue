    ...
    <v-row row wrap>
        <v-col cols="12">
            <v-text-field
                    ...
                    single-line
                    hide-details
                    v-on:keyup.native.enter="loadUsers"
            ></v-text-field>
        </v-col>
        ...
        <v-col cols="12">
            <v-data-table
                    ...
                    @update:sort-by="loadUsers"
                    @update:sort-desc="loadUsers"
            >
...
<script>
    ...
    export default {
        ...
        methods: {
            loadUsers() {
                this.loading = true
                UserProvider.paginateUsers(this.limit, this.pageNumber, this.search, this.getOrderBy, this.getOrderDesc)
                    .then(r => {
